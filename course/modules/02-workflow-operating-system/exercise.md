...
1. A short description of the workflow
2. Three rules that would belong in `AGENTS.md`
3. A first entry for `PROGRESS.md`
4. A short spec with:
...
5. One skill that would improve repeated execution
