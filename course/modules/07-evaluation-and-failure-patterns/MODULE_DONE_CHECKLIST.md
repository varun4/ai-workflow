...
- [x] developer `MODULE_UPDATES.md` includes `module-07.md`
- [x] knowledge-worker `MODULE_UPDATES.md` includes `module-07.md`
...
- `pymarkdown scan <module-07 changed files>`
