# Module 01 Done Checklist

## Deterministic Checks

- [x] `lesson.md` exists
- [x] `slides-outline.md` exists
- [x] `exercise.md` exists
...
- [x] developer delta exists:
      `examples/developers/rbac-admin-workflow/deltas/module-01.md`
- [x] knowledge-worker delta exists:
      `examples/knowledge-workers/vendor-selection-workflow/deltas/module-01.md`

- [x] developer `MODULE_UPDATES.md` includes `module-01.md`
- [x] knowledge-worker `MODULE_UPDATES.md` includes `module-01.md`

- [x] at least one developer workflow artifact updated for this module
...
- `pymarkdown scan <module-01 changed files>`

## Completion Decision

- [x] PASS (all checks true)
