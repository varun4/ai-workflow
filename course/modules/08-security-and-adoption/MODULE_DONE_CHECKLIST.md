...
- [x] developer `MODULE_UPDATES.md` includes `module-08.md`
- [x] knowledge-worker `MODULE_UPDATES.md` includes `module-08.md`
...
- `pymarkdown scan <module-08 changed files>`
