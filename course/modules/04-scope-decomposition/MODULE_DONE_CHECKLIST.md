...
- [x] developer `MODULE_UPDATES.md` includes `module-04.md`
- [x] knowledge-worker `MODULE_UPDATES.md` includes `module-04.md`
...
- `pymarkdown scan <module-04 changed files>`
