...
- [x] developer `MODULE_UPDATES.md` includes `module-03.md`
- [x] knowledge-worker `MODULE_UPDATES.md` includes `module-03.md`
...
- `pymarkdown scan <module-03 changed files>`
